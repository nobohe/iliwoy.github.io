	...
	theme = {
		...
		----------------------------*/
	 	_init : function(){
		    ...
		    $(vars.openlink_button).click(function() {
                var url = $('li iframe', vars.thumb_list).eq(vars.current_slide).attr('src');
                window.open(url);
		    });
	 ...
	 $.supersized.themeVars = {
		...
		image_path			:	'assets/img/',				// Default image path
													
		// General Elements							
		openlink_button		:	'#openlink',		// Open link button
